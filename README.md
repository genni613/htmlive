...
- Delete selected text, buttons, or other elements, including multi-selection
...
4. 点击元素后进入编辑模式：双击文字即可编辑；用 `⠿` 拖动元素、用 `↘` 调整大小，或按 `Delete`/`Backspace` 删除。
